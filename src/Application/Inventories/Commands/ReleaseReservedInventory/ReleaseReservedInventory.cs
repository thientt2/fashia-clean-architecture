...
public sealed record ReleaseReservedInventoryCommand : IRequest
{
...
public sealed class ReleaseReservedInventoryCommandHandler
    : IRequestHandler<ReleaseReservedInventoryCommand>
{
    ...
    )
    {
        ...
        _context.InventoryTransactions.Add(
            new InventoryTransaction(
                ...
                InventoryTransactionType.ReleaseReservation,
                request.Quantity,
                request.Note,
