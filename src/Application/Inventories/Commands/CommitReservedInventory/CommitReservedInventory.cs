...
public sealed record CommitReservedInventoryCommand : IRequest
{
...
public sealed class CommitReservedInventoryCommandHandler
    : IRequestHandler<CommitReservedInventoryCommand>
{
    private readonly IApplicationDbContext _context;
    private readonly IUser _user;
    private readonly IBranchAuthorizationService _branchAuthorizationService;

    public CommitReservedInventoryCommandHandler(
    ...
    public async Task Handle(
        CommitReservedInventoryCommand request,
    ...
    )
    {
        ...
        inventory.CommitReservedStock(request.Quantity);

        _context.InventoryTransactions.Add(
            new InventoryTransaction(
                request.BranchId,
                request.ProductVariantId,
                InventoryTransactionType.CommitReservation,
                request.Quantity,
                request.Note,
